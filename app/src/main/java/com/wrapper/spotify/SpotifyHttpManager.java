...
public class SpotifyHttpManager implements HttpManager {
  ...
  @Override
  public String post(Url url) throws IOException, WebApiException {
    assert (url != null);
  ...
  @Override
  public String put(Url url) throws IOException, WebApiException {
    assert (url != null);
  ...
  @Override
  public String delete(Url url) throws IOException, WebApiException {
    assert (url != null);
